...
#												#
# We used this pipeline for our DMD and Military samples		 			#
# at Georgetown University (2013-2014)								#
#												#
# Authors: Lin An (la512@georgetown.edu); Difei Wang (difei.wang@georgetown.edu)		#
#-----------------------------------------------------------------------------------------------#
...
## Setting Directories
## change this path to where your CDF files reside 
